...
fn tumo_calc(fu: u8, han: u8) -> Points {
    match han {
        0..=4 => {}
        5 => return Points::ChildTumo(2000, 4000),
        6 | 7 => return Points::ChildTumo(3000, 6000),
        8 | 9 | 10 => return Points::ChildTumo(4000, 8000),
        11 | 12 => return Points::ChildTumo(6000, 12000),
        13..=u8::MAX => return Points::ChildTumo(8000, 16000),
    }
...
fn ron_calc(fu: u8, han: u8) -> Points {
    match han {
        0..=4 => {}
        5 => return Points::Ron(8000),
        6 | 7 => return Points::Ron(12000),
        8 | 9 | 10 => return Points::Ron(16000),
        11 | 12 => return Points::Ron(24000),
        13..=u8::MAX => return Points::Ron(36000),
    }
...
fn tumo_20fu(han: u8) -> Points {
    ...
    Points::ChildTumo(score.0, score.1)
}
...
mod table_test {
    use crate::calculator::result::Points;
    use crate::calculator::result::Points::{ChildTumo, Ron};
    use crate::calculator::score::child::{ron_calc, tumo_calc};
    use std::collections::HashMap;

    #[test]
    fn test_tumo() {
        const MANGAN_TUMO: Points = ChildTumo(2000, 4000);
        ...
        let tumo_110: Vec<(u8, Points)> = vec![
    ...
    #[test]
    fn test_ron() {
        const MANGAN_RON: Points = Ron(8000);

        let ron_25: Vec<(u8, Points)> = vec![(2, Ron(1600)), (3, Ron(3200)), (4, Ron(6400))];
